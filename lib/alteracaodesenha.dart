...
import 'package:loguinsintese_app/atSenha.dart';
import 'Phome.dart';
      ...
      Widget okButton = FlatButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (BuildContext context) => phome(widget.CpfDigitado)));
        },
      );
                      ...
                      return Column(
                          ...
                          children: <Widget>[
                            Align(
                              ...
                              child: Text('Atualização de senha', style: TextStyle(fontSize: 20),),
                            ),
                            SizedBox(
                              height: 05.0,
                            ),
                            ...
                            Padding(
                              ...
                              child: RaisedButton(
                                  ...
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(10)),
                                  onPressed: () {
                                    if((_controllernovasenha.text == '') || (_controllerconfirmacaodesenha.text == '')){
                                      Widget okButton = FlatButton(
                                        child: Text("OK"),
                                        onPressed: () {
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (BuildContext context) => alteracaodesenha(widget.CpfDigitado)));
                                        },
                                      );
                                      AlertDialog alerta = AlertDialog(
                                        title: Text("Atenção!"),
                                        content: Text("Senha ou confirmação de senha, não podem está vazio"),
                                        actions: [okButton],
                                      );
                                      showDialog(
                                          context: context,
                                    ...
                                    } else  if((_controllernovasenha.text != _controllerconfirmacaodesenha.text)){
                                      Widget okButton = FlatButton(
                                        child: Text("OK"),
                                        onPressed: () {
                                          Navigator.push(
                                      ...
                                      AlertDialog alerta = AlertDialog(
                                        title: Text("Atenção!"),
                                        content: Text("As senha digitadas não conferem"),
                                        actions: [okButton],
                                      );
                                      showDialog(
                                          context: context,
